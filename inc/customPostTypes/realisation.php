...
/**
 * This is an example file showcasing how you can add custom Réalisations to your Flynt theme.
 *
...
add_action('init', function (): void {
    $labels = [
        'name' => _x('Réalisations', 'Réalisation General Name', 'flynt'),
        'singular_name' => _x('Réalisation', 'Réalisation Singular Name', 'flynt'),
        'menu_name' => __('Réalisations', 'flynt'),
        'name_admin_bar' => __('Réalisation', 'flynt'),
    ...
    $args = [
        'label' => __('Réalisation', 'flynt'),
        'description' => __('Réalisation Description', 'flynt'),
        'labels' => $labels,
        'supports' => ['title', 'editor', 'revisions'],
        'taxonomies' => ['type_realisation', 'post_tag'],
        'hierarchical' => false,
        'public' => true,
        'show_ui' => true,
        'show_in_menu' => true,
