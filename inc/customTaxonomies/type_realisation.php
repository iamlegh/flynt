...
add_action('init', function (): void {
    $labels = [
        'name' => _x('Types', 'Taxonomy General Name', 'flynt'),
        'singular_name' => _x('Type', 'Taxonomy Singular Name', 'flynt'),
        'menu_name' => __('Type', 'flynt'),
    ...
    register_taxonomy('type_realisation', ['realisation'], $args);
});
